    ...
    $.ajax({
        ...
        success: function (resp) {
            resp['non_courseware_topics'].forEach(element => {
                getAndPopulateCertainTopic(element['id'], element['name'], element['thread_list_url']);
            });
        },
        error: function (resp) {
...
function getAndPopulateCertainTopic(topicId, topicName, url) {
    $.ajax({
        type: 'GET',
        url: url,
        success: function (resp) {
...
function getAndPopulateAllDiscussions() {
    $.ajax({
        type: 'GET',
...
function getAndPopulateFollowingPosts() {
    $.ajax({
        type: 'GET',
...
// methods to be called on the loading of screen
